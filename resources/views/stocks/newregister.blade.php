...
@section('content')
    <div class="main-area col-md-10 p-4 rounded">
        <h1 class="ticker text-center m-4" style="color: #a27fa3; font-size:2rem; text-shadow: 1px 1px 1px #4e4e4e;">Act Now!</h1>
        <div class="row">
            <div class="col-sm-6">
